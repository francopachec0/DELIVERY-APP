      ...
      {data &&
        data.map((item) => {
          return (
            <div
              key={item?.id}
              className="w-275 h-[175px] min-w-[275px] md:w-300 md:min-w-[300px] bg-cardOverlay rounded-lg py-2 px-4 my-6 backdrop-blur-lg hover:drop-shadow-xl flex flex-col items-center justify-between relative"
            >
